...
# Blob 1: Left motor cortex (large, strong activation)
arr <- add_gaussian_blob(arr, cx = 60, cy = 50, cz = 55, peak_value = 8, sigma = 5)

# Blob 2: Right motor cortex (moderate)
arr <- add_gaussian_blob(arr, cx = 32, cy = 50, cz = 55, peak_value = 6, sigma = 4)

# Blob 3: Supplementary motor area (SMA)
arr <- add_gaussian_blob(arr, cx = 46, cy = 40, cz = 65, peak_value = 5.5, sigma = 3)

# Blob 4: Left visual cortex (small, strong)
arr <- add_gaussian_blob(arr, cx = 55, cy = 85, cz = 30, peak_value = 7, sigma = 3)

# Blob 5: Right visual cortex (small, moderate)
arr <- add_gaussian_blob(arr, cx = 37, cy = 85, cz = 30, peak_value = 5, sigma = 3)
